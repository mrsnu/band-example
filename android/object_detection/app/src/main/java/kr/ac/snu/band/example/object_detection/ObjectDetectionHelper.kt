...
package kr.ac.snu.band.example.object_detection
 ...
 */
class ObjectDetectionHelper(private val engine: Engine, private val model: Model, private val labels: List<String>) {
